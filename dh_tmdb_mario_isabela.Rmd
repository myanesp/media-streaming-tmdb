...
-   A matrix equivalence of genres ids and genres names for movies &rarr; `get_movie_genres()`
-   A matrix equivalence of genres ids and genres names for TV shows &rarr; `get_tv_genres()`
...
remDr$findElement(using = "xpath", value = '/html/body/div[1]/main/section/div/div/div/div[2]/div[1]/div[2]/div[1]')$clickElement()
filter$clickElement()
...
search <- remDr$findElement(using = "xpath", value = '/html/body/div[1]/main/section/div/div/div/div[2]/div[1]/div[4]/p')
search$clickElement()
